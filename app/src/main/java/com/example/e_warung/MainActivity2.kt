...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        kurang1 = findViewById(R.id.imageButton2)
        kurang2 = findViewById(R.id.imageButton4)
        plus1 = findViewById(R.id.imageButton3)
        plus2 = findViewById(R.id.imageButton5)
        jum1 = findViewById(R.id.textView15)
        jum2 = findViewById(R.id.textView22)
        jumlahtotal = findViewById(R.id.textView27)
        totalBayar = findViewById(R.id.textView28)
